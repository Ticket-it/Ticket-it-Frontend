...
public class AdminUserHistoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Call<HistoryMainResponse> call = adminService.getHistory(userId);
        call.enqueue(new Callback<HistoryMainResponse>() {
            ...
            public void onResponse(@NonNull Call<HistoryMainResponse> call, Response<HistoryMainResponse> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    eventHistoryAdapter = new EventHistoryAdapter(AdminUserHistoryActivity.this, listHistory);
                    eventsHistoryRecyclerView.setLayoutManager(new GridLayoutManager(AdminUserHistoryActivity.this, 1));
            ...
            public void onFailure(Call<HistoryMainResponse> call, Throwable t) {
                Toast.makeText(AdminUserHistoryActivity.this, t.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
